...
export default function RootFeedPage() {
  ...
  const feedItems = useMemo(() => {
    ...
    // Fixed: Explicitly typed the items array to prevent Next.js 15 build error
                  ...
                  <>
                    <Link href="/notifications" className="relative">
                        ...
                        {unreadNotificationsCount > 0 && (
                          <span className="absolute -top-1 -right-1 h-5 w-5 bg-red-600 rounded-full flex-center text-[10px] font-bold">
