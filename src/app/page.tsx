...
export default function HomePage() {
  ...
  const items = useMemo(() => {
    ...
    shuffledPosts.forEach((post, index) => {
      ...
      // Insert an ad every 2 posts for maximum earning
      if ((index + 1) % 2 === 0) {
        displayItems.push({
          type: 'ad',
          data: {
            ...
            caption: "Unlock the full potential of your world with A.snap Premium. Experience smooth, ad-free visuals and exclusive features!",
