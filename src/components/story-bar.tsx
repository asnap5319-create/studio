...
export function StoryBar() {
  ...
  const { data: activeStories, isLoading, error } = useCollection<ActiveUserStory>(storiesQuery);
                ...
                <div className="flex-1 relative bg-black flex items-center justify-center overflow-hidden">
                    ...
                    <div className="absolute top-12 right-6 flex flex-col gap-5 z-[70]">
                        <button 
                            ...
                            className="p-4 rounded-full bg-white/20 backdrop-blur-xl border border-white/20 text-white shadow-2xl transition-all active:scale-90"
                        >
                    ...
                    <button 
                        ...
                        className="absolute top-12 left-6 p-4 bg-white/10 backdrop-blur-xl rounded-full border border-white/20 text-white z-[70] shadow-2xl"
                    >
                        <X size={24} />
                    </button>
                </div>
                        ...
                        <div className="space-y-10 flex-1 flex flex-col justify-center">
                            ...
                            {overlayText && (
                                <div className="space-y-12 animate-in slide-in-from-bottom-5 duration-500">
                                    <div className="grid grid-cols-1 gap-8">
                                        <div className="space-y-4">
                                            <div className="flex justify-between items-center px-1">
                                                <span className="text-[10px] font-black uppercase text-white/50 tracking-widest">Position Up/Down</span>
                                    ...
                                    <div className="space-y-4">
                                        <span className="text-[10px] font-black uppercase text-white/50 tracking-widest flex items-center gap-2 px-1"><Palette size={12} /> Pick Color</span>
                                            ...
                                            {COLORS.map((c) => (
                                                <button 
                                                    ...
                                                    className={cn(
                                                        ...
                                                        overlayColor === c.value ? "border-white scale-125" : "border-transparent opacity-50"
                                                    )}
                ...
                <div className="relative w-full h-full flex flex-col bg-black">
                    ...
                    <div className="absolute top-0 left-0 right-0 p-6 z-50 bg-gradient-to-b from-black/80 to-transparent pt-12">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <button onClick={() => setIsViewerOpen(false)} className="text-white bg-black/20 backdrop-blur-md p-2 rounded-full"><X size={20} /></button>
                        </div>
                    </div>
                </div>
            )}
