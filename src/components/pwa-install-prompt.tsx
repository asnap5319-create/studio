      ...
      <div className="bg-gradient-to-r from-[#0a0a0a] to-[#1a1a1a] border border-white/10 p-5 rounded-[2rem] shadow-[0_20px_60px_rgba(0,0,0,0.9)] flex items-center justify-between gap-4 backdrop-blur-2xl relative overflow-hidden">
        ...
        <div className="flex items-center gap-4 relative z-10">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-1.5">
               ...
               <Sparkles className="h-3 w-3 text-[#ff3366] animate-pulse shrink-0" />
            </div>
        ...
        <div className="flex items-center gap-2 relative z-10">
            <Button 
                ...
                className="h-12 px-6 bg-[#ff3366] text-white font-black uppercase text-xs rounded-xl shadow-[0_10px_25px_rgba(255,51,102,0.3)] hover:scale-105 active:scale-95 transition-all flex items-center gap-2"
            >
